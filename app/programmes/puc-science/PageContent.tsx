...
// PCMB Colleges Section
const PCMBCollegesSection = () => {
  return (
          ...
          <div>
            <p className="text-gray-700 mb-4">
              ...
              <em className="font-semibold">
                Top PU colleges for PCMB Science in Bangalore
              </em>{" "}
              and part of the{" "}
              <Link href="#" className="text-blue-600 hover:underline">
                JAIN Group
...
// Best PCMB Colleges Section
const BestPCMBSection = () => {
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-2">
          Best PCMB colleges in Bangalore
        </h2>
        <div className="w-24 h-1 bg-[#F8C300] mx-auto mb-12"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <p className="text-gray-700 mb-4">
              Bangalore is home to some of the top Science (PCMB) colleges,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <p className="text-gray-700 mb-6">
              Whether you aspire to study engineering, medicine, or management
              in college, JAIN College has structured programmes to help
              students prepare for the entrance tests. Students will be offered
              classes and practice question papers to help them regularly
              prepare for these exams without losing sight of their PUC board
              exam preparations.
            </p>
...
// PUC Science Subjects Accordion Section
      ...
      content: (
        <div className="p-4">
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Passed Class 10 (SSLC/CBSE/ICSE) with minimum 60% aggregate</li>
            <li>Minimum 60% in Science and Mathematics</li>
...
// Scopes of Studying PCMB Section
const ScopesSection = () => {
  const degrees = [
    ...
    <section className="bg-[#001C54] py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-2">
          Scopes of studying PCMB from Best PU College in Bangalore
        </h2>
        <div className="w-24 h-1 bg-[#F8C300] mx-auto mb-12"></div>
  ...
  const accordionItems = [
    {
      ...
      content: (
        <div className="p-4 text-gray-700 space-y-4">
          ...
          <p>
            Our state-of-the-art facilities include modern laboratories equipped
            with advanced equipment and apparatus. Here, students conduct
            experiments and research under the guidance of experienced faculty
            members. We use engaging and relevant teaching methods. They broaden
            perspectives and deepen understanding. They also foster awareness in
            our students.
          </p>
        </div>
      ),
      ...
      content: (
        <div className="p-4 text-gray-700 space-y-4">
          <p>
            ...
            to help students make informed decisions about their future. Regular
            parent-teacher meetings ensure continuous communication about
            student progress.
          </p>
          <p>
...
const HallmarksSection = () => {
  const hallmarks = [
    ...
    { icon: "🏆", title: "Mastering", subtitle: "Academics, Sports and Arts" },
  ];
...
// Main Page
export default function PUCSciencePageContent() {
  return (
    <>
      <Header />
      <main>

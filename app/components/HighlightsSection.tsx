const highlights = [
  {
    title: "Global Academic Pathway Progression",
    description:
      "Students benefit from structured international progression routes that allow them to transfer to partner universities abroad and complete their degrees internationally.",
    icon: (
  ...
  {
    title: "Cost-Effective Global Education",
    description:
      "Beginning studies in India significantly reduces the cost of international education while keeping global progression opportunities open.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Programs are designed in alignment with global academic standards to ensure smooth credit transfer and academic progression to international universities.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {highlights.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-[#F8C300] font-bold text-lg mb-3">
                {item.title}
              </h3>
